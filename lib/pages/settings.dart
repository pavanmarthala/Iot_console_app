    ...
    return Scaffold(
      ...
      //  drawer: Drawer(),
       appBar: AppBar(
        ...
        backgroundColor: Colors.white,
         title: const Text("settings", style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black,fontSize: 25),),
       ...
       body: ListView(
        children: [
          Row(  
            ...
            children: [
              ...
              Padding(
                ...
                child: Text("Welcome, Teja Karimireddy",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 20),),
              ), 
            ],
          ),
          Padding(
              ...
              children: [
                Container(
                  ...
                  child:Padding(
                    ...
                    child: Row(
                      children: [
                        Text('Subscription Validity',style: TextStyle(fontSize: 17),),
                        SizedBox(width: 65,),
         ...
         ListTile(
              title: const Text("Renew Subscription",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20)),
        ...
        ListTile(
              title: const Text("Set Limits",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20)),
          ...
          SizedBox(height: 10,),
             ...
             ListTile(
              title: const Text("Notifications",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20)),
          ...
          SizedBox(height: 10,),
             ...
             ListTile(
              title: const Text("Sign Out",style: TextStyle(fontWeight: FontWeight.w400,fontSize: 20)),
